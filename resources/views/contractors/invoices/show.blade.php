    ...
    <div class="box box-success">
        <section class="invoice">
            ...
            <div class="box-footer row no-print">
                <div class="col-md-10">
                    <a href="{{ url('contractors/invoices/' . $invoice->id . '/print') }}" target="_blank" class="btn btn-default">
                        <i class="fa fa-print"></i>&nbsp; {{ trans('general.print') }}
                    </a>
                    <a href="{{ url('contractors/invoices/' . $invoice->id . '/pdf') }}" class="btn btn-default" data-toggle="tooltip" title="{{ trans('invoices.download_pdf') }}">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $(document).on('change', '#payment-method', function (e) {
                ...
                $.ajax({
                    url: '{{ url("contractors/invoices/" . $invoice->id) }}/' + gateway[0],
                    type: 'GET',
                    dataType: 'JSON',
