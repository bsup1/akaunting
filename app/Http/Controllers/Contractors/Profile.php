...
use App\Http\Requests\Contractor\Profile as Request;
...
class Profile extends Controller
{
    ...
    public function edit()
    {
        ...
        return view('contractors.profile.edit', compact('user'));
    }
    ...
    public function update(Request $request)
    {
        ...
        // Update contractor
        $user->contractor->update($request->input());

        $message = trans('messages.success.updated', ['type' => trans('auth.profile')]);

        flash($message)->success();

        return redirect('contractors/profile/edit');
    }
    ...
    public function readOverdueInvoices()
    {
        ...
        return redirect('contractors/invoices');
    }
}
