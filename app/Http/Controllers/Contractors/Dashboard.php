...
class Dashboard extends Controller
{
    ...
    public function index()
    {
        ...
        $invoices = Invoice::with('status')->accrued()->where('customer_id', $contractor->id)->get();
        ...
        return view('contractors.dashboard.index', compact('contractor', 'invoices', 'progress', 'chart'));
    }
